...
Conclusion from CHAPTER 1 and 2: It seems that the dll-s are not brought over from the libraries to our bin directory... The above can only be a temporary solution.
